...
public class AESUtil {
    ...
    public static void main(String[] args) {
        try{
            ...
            // 生成AES密钥
            String key=AESUtil.generateKeyString();
            //    			String key = "1234567890123456";
            System.out.println("AES-KEY:" + key);

            // 内容
            String content =  "{\"api_userid\":\"SWyjsUpSySb\",\"idType\":1,\"encrypt\":\"clear\",\"mdn\":\"189****1999\",\"name\":\"朱**良\",\"idNo\":\"3326*****3091819\"}";
            // 用AES加密内容
            String miContent = AESUtil.encrypt(content, "6369BE91F580F990015D709D4D69FA41");
            System.out.println("AES加密后的内容:" + miContent);
            // 用AES解密内容
            String mingContent = AESUtil.decrypt(miContent, "6369BE91F580F990015D709D4D69FA41");
